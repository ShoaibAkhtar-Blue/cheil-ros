...
class TaskDeploymentAdapter(val context: Context, val itemList: List<ActivityCategoryData>, val arguments: Bundle?): RecyclerView.Adapter<TaskDeploymentAdapter.ViewHolder>(),
    Filterable {
