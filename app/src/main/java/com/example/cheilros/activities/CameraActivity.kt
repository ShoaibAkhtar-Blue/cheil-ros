                ...
                photo
                    ?.let {
                        ...
                        if (CSP.getData("fragName").equals("ActivityDetail")) {
                            ...
                            finish()
                        }else if (CSP.getData("fragName").equals("StorePicture")) {
                            println("StorePicture")
                            val savedImagePath: String = saveMediaToStorage(bitmapImg)
                            println(savedImagePath)
                            CSP.saveData("StorePicture_SESSION_IMAGE", savedImagePath)
                            finish()
                            ...
                            val savedImagePath: String = saveMediaToStorage(bitmapImg)
                            println(savedImagePath)
                            CSP.saveData("Checklist_SESSION_IMAGE", savedImagePath)
                            finish()
                        }else if (CSP.getData("fragName").equals("PriceDetail")) {
                            println("PriceDetail")
                            val savedImagePath: String = saveMediaToStorage(bitmapImg)
                            println(savedImagePath)
                            CSP.saveData("PriceDetail_SESSION_IMAGE", savedImagePath)
                            finish()
